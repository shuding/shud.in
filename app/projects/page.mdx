...
import { Nextjs, V0, SWR, Nextra, AISDK, Satori, COBE, ReactWrapBalancer, NextViewTransitions, ReactBestPractices, Plaintext, Vercel } from '@/components/project-logos'
...
## [<ReactBestPractices height={18}/>](https://github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices 'React Best Practices')

I created [React Best Practices](https://github.com/vercel-labs/agent-skills/tree/main/skills/react-best-practices) in 2026, a framework with 40+ performance rules for React and Next.js, designed for developers and AI agents ([announcement](https://vercel.com/blog/introducing-react-best-practices-5YHsgAKetHewgOB3xbmz3T)).
...
- [<Plaintext title="Better All"/>](https://github.com/shuding/better-all 'Better All')
