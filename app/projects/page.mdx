...
I have been a core maintainer of [Next.js](https://nextjs.org) since 2020, collaborating closely with the React team to drive significant advancements. I led the development of Streaming SSR, Edge Runtime, React Server Components, Server Actions and other major architectural improvements in Next.js ([full list of contributions](https://github.com/vercel/next.js/pulls?q=is%3Apr+author%3Ashuding+is%3Aclosed+sort%3Acreated-desc)).
...
My other projects (find all of them on [GitHub](https://github.com/shuding)):
