...
const images = [
  ...
  // {
  //   url: 'https://wtw3stpubzkzkxjf.public.blob.vercel-storage.com/interference-CSRE0loAEtcOqblk7t1Mx5MlOh3NPT.png',
  //   width: 1600,
  //   height: 1600,
  // },
  {
  ...
  return (
    <div className='flex flex-wrap gap-4'>
      {images.map((image) => (
        <div
          key={image.url}
          className='relative flex-1 shrink-0 basis-1/3 max-w-[calc(50%-0.5rem)] flex items-center bg-gradient-to-br from-rurikon-100/60 to-transparent'
        >
          <Image
            src={image.url}
            alt='Image'
