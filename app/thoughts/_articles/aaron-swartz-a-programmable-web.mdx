export const metadata = {
  ...
  date: '2016.05.21',
  description: 'At the time when I was getting into web development, I had the chance to read one of the most inspiring books about the web, Aaron Swartz\'s A Programmable Web. And it completely changed my mind.',
}
